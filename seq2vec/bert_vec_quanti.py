...
config_path = 'output_zhijian_quanti/config.json'
model_path = 'output_zhijian_quanti/pytorch_model.bin'
vocab_path = 'output_zhijian_quanti/vocab.txt'
bert_path = 'output_zhijian_quanti/'
