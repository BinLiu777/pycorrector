...
config_path = 'models/quanti_bert/bert_config.json'
model_path = 'models/quanti_bert/pytorch_model.bin'
vocab_path = 'models/quanti_bert/vocab.txt'
bert_path = 'models/quanti_bert/'

#config_path = 'models/bert/bert_config.json'
#model_path = 'models/bert/pytorch_model.bin'
#vocab_path = 'models/bert/vocab.txt'
...
al_config_path = 'models/torch_albert_base_zh_additional_36k_steps/config.json'
al_model_path = 'models/torch_albert_base_zh_additional_36k_steps/pytorch_model.bin'
al_vocab_path = 'models/torch_albert_base_zh_additional_36k_steps/vocab.txt'
#al_config_path = 'models/torch_albert_xlarge_zh_177k/config.json'
#al_model_path = 'models/torch_albert_xlarge_zh_177k/pytorch_model.bin'
#al_vocab_path = 'models/torch_albert_xlarge_zh_177k/vocab.txt'
#al_config_path = 'models/albert_xlarge_bright/config.json'
#al_model_path = 'models/albert_xlarge_bright/pytorch_model.bin'
#al_vocab_path = 'models/albert_xlarge_bright/vocab.txt'
...
class BertTextNet(nn.Module):
    def __init__(self):
        ...
        #print(self.textExtractor)
        self.textExtractor = torch.quantization.quantize_dynamic(model, {torch.nn.Linear}, dtype=torch.qint8)
